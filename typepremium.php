...
if(isset($_GET['current']))
{
    ...
    if($uResult)
    {
      header('location:typepremium.php?updated=true&val='.$curr.'');
    }
}
?>
<div class="container">
...
if(isset($_SESSION['email']) && $_SESSION['email'] == "admin@gmail.com")
{
  ...
  echo '<a class="btn btn-success my-4" href="typeadd.php?albumType=1">Add New Album</a>';
}
?>
  ...
  <div class="card-body">
    ...
    <?php
      if(isset($_SESSION['email']) && $_SESSION['email'] == "admin@gmail.com")
      {
        ...
        echo '<a href="typepremium.php?current='. $button .'&albumid='.$detail['id'].' " class="btn btn-success ">'.$button.'</a>';
      }
    ?>
    <?php
   echo '</div>
